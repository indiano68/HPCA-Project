...
/**
 * @brief Variation of the previous kernel. The for loop on merge length is moved outside the kernel. This kernel is called from the host for each merge length.
 */
template <typename T>
